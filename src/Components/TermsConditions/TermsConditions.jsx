...
export function Termsconditions() {
  return (
    <>
      <Header />
      <div className="changepassword-main-div" style={{ marginBottom: "50px" }}>
        <div className="">
              ...
              <div className="row">
                <div className="col-lg-12">
                  <div className="breadcrumb-contents">
                    ...
                    <h6 className="breadcrumb-title">Terms & Conditions</h6>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container">
          <div>
            <h2 className="terms4">
              <b>Welcome to SafeCart!</b>
            </h2>
            <p className="terms5">
              These terms and conditions outline the rules and regulations for
              the use of SafeCart's Website, located at safecart.byteseed.
              com.By accessing this website we assume you accept these terms and
              conditions. Do not continue to use SafeCart if you do not agree to
          ...
          <div>
            ...
            <p className="terms5">
              We employ the use of cookies. By accessing SafeCart, you agreed to
              use cookies in agreement with the SafeCart's Privacy Policy. Most
          ...
          <div className="terms6">
            ...
            <p className="terms5">
              Unless otherwise stated, SafeCart and/or its licensors own the
              intellectual property rights f or all material on SafeCart. All
              intellectual property rights are reserved. You may access this
              from SafeCart for your own personal use subjected to restrictions
              set in these terms and conditions. You must not:
            </p>
            <p className="terms5">
              Republish material from SafeCart Sell, rent or sub-license
              material from SafeCart Reproduce, duplicate or copy material from
              SafeCart Redistribute content from SafeCart
            </p>
            <p className="terms5">
              ...
              website. SafeCart does not filter, edit, publish or review
              Comments prior to their presence on the website. Comments do not
              reflect the views and opinions of SafeCart, its agents and/or
              ...
              applicable laws, SafeCart shall not be liable for the Comments or
              ...
              Comments on this website. SafeCart reserves the right to monitor
            ...
            <p className="terms5">
              You hereby grant SafeCart a non-exclusive license to use,
